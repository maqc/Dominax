...
domino001.x : domino001.c mostra_mao.c monta_pm.c teste_toque.c teste_final.c teste_peca.c contagem_maos.c random.c
	gcc -Wall -Wextra -O0 -g domino001.c mostra_mao.c monta_pm.c teste_toque.c teste_final.c teste_peca.c contagem_maos.c random.c -o domino001.x  2>&1 | tee errors_domino001.txt
